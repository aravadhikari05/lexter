...
Nothing is underlined in a statute citation. "Section" is indicated by the "§" symbol, the plural of which is "§§." For further guidance concerning citation of individual sections and subsections, see [rule 3.3](../Whitepages/3_3_sections_and_paragraphs.md).

**Codes and Session Laws**

For statutes, cite a current official or unofficial **code**, an official or privately published collection of **session laws**, or a **secondary source**. [Rule 12](../Whitepages/12_statutes.md) provides a full explanation of these sources and how to decide which one to include in your citation.

If available, cite the current official code for statutes currently in force. The official code for federal statutes is the <u>United States Code</u>, which is abbreviated "U.S.C."
...
 Omit the year parenthetical if the name of the statute includes its year of enactment.

For guidance on how to indicate a statute's prior or subsequent history, see [rule 12.7](../Whitepages/12_7_invalidation_repeal_amendment_and_prior_history.md).

B12.1.2 -- State Statutes
------------------------

For state statutes, cite an official code if available. [Table T1.3](../Tables/t1_3_states_and_the_district_of_columbia.md) lists the official and unofficial statutory compilations of each state, with the preferred official code listed first. Although the citation form for individual state codes varies, a full citation of most state codes includes the following elements: (1) the abbreviated name of the code, as listed in [table T1.3](../Tables/t1_3_states_and_the_district_of_columbia.md); (2) the cited section number(s); and (3) the year of the cited code edition (not the year the act was passed). Citations of an unofficial state code must also include the name of the publisher in the date parenthetical:
...
For guidance on citing state session laws, see [rule 12.4](../Whitepages/12_4_session_laws.md).
...
For further guidance on citing procedural rules, restatements, uniform acts, and similar acts, see [rule 12.9](../Whitepages/12_9_special_citation_forms.md).

B12.1.4 -- Federal Tax Materials
-------------------------------

Citation of federal tax materials is governed by special rules discussed in [rule 12.9.1](../Whitepages/12_9_special_citation_forms.md) and [table T1.2](../Tables/t1_2_federal_administrative_and_executive_materials.md). In court documents and legal memoranda discussing only the current version of federal tax laws, you may omit the year and publisher parenthetical from citations of the Internal Revenue Code (I.R.C.) and Treasury regulations.
...
When citing Treasury determinations in court documents and legal memoranda, you may use the abbreviations contained in the introductory pages of the <u>Cumulative Bulletin</u>. Thus, you may cite General Counsel Memoranda as "G.C.M." When citing Private Letter Rulings, you may use the abbreviation "P.L.R." and omit the dashes from the ruling number:
...
Tax Court and Board of Tax Appeals decisions are cited as court decisions, not agency decisions. For further guidance, see [table T1.1](../Whitepages/t1_1_federal_judicial_and_legislative_materials.md).

For guidance on citing materials from other administrative agencies, see [table T1.2](../Tables/t1_2_federal_administrative_and_executive_materials.md).