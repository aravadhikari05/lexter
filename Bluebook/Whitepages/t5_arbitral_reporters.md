T5 Arbitral Reporters (p.333)
=============================

This list provides abbreviations for arbitration reporters. See [rule 21.6](https://www.legalbluebook.com/bluebook/v22/rules/21-international-materials/21-6-international-arbitrations-and-claims-commissions) for guidance on citing international arbitrations.
...
| International Chamber of Commerce Arbitration<br> | Int'l Com. Arb. |
