T7 Court Names (pp. 337--39)
===========================

The following alphabetical list provides abbreviations for court names to be used in citing cases according to [rule 10.4](https://www.legalbluebook.com/bluebook/v22/rules/10-cases/10-4-court-and-jurisdiction). If the abbreviation for the full name of the court is not listed below, a composite abbreviation may be assembled using the words listed in this table.
...
| Foreign Intelligence Surveillance Court of Review | F.I.S.C.R. |
| High Court | High Ct. |
