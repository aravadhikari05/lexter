...
export default function CitationCards({ result, onEdit }: Props) {
    ...
    <div className="animate-fade-up" style={{ maxWidth: '92%', display: 'flex', flexDirection: 'column', gap: 8 }}>
      <div style={{
            ...
            <div key={t.key} style={{
              ...
              <p
                style={{
                  ...
                  fontSize: 14, lineHeight: 1.85, color: 'var(--text)', flex: 1, minWidth: 0,
                }}
        ...
        <div style={{
          ...
          <span style={{ fontSize: 9, color: 'var(--dimmer)', letterSpacing: '.08em' }}>RULES USED:</span>
          <span style={{ fontSize: 9, color: 'var(--faint)', letterSpacing: '.06em' }}>{active.rule}</span>
        </div>
